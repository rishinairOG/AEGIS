"""
Tests for AegisMemory (HippoMem wrapper).
...
class TestAegisMemoryInit:
    """AegisMemory construction and config."""

    def test_memory_class_import(self):
        from memory import AegisMemory
        assert AegisMemory is not None
...
class TestAegisMemoryWithoutService:
